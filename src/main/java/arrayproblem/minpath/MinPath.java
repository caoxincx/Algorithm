...
public class MinPath {
    ...
    private static int[][] arr = {
            {14,20,0,0,10,0,0,13,7,18,3,12,0,0,11,0,0,5,6},
            {18,0,0,19,0,0,6,0,0,0,0,0,15,0,0,9,0,0,22},
            {21,0,2,0,0,-13,0,0,2,8,3,0,0,17,0,0,12,0,5},
            {-15,0,22,0,10,0,0,16,0,0,0,15,0,0,20,0,9,0,23},
            {17,0,-13,0,-9,0,16,0,0,2,0,0,11,0,3,0,6,0,-9},
            {10,0,4,0,18,0,21,0,20,0,5,0,15,0,12,0,22,0,13},
            {19,0,11,0,20,0,14,0,0,16,0,0,8,0,21,0,-15,0,16},
            {-10,0,4,0,6,0,0,4,0,0,0,15,0,0,-10,0,7,0,18},
            {3,0,5,0,0,14,0,0,11,-10,19,0,0,22,0,0,23,0,13},
            {21,0,0,9,0,0,9,0,0,0,0,0,4,0,0,8,0,0,17},
            {10,12,0,0,7,0,0,13,19,-10,7,14,0,0,17,0,0,2,8}
    };
    // 当前所在位置
